...
namespace Koubot.Tool.KouData
{
    ...
    public static class KouStaticData
    {
        ...
        /// 动词列表
        /// </summary>
        public static readonly IReadOnlyList<string> Verb = new List<string>()
        {
            "看", "望", "瞥", "视", "盯", "瞧", "窥", "瞄", "眺", "瞪", "瞅", "听", "咬", "吞", "吐", "吮", "吸", "啃", "喝", "吃", "咀",
            "嚼", "搀", "抱", "搂", "扶", "捉", "擒", "掐", "推", "拿", "抽", "撕", "摘", "拣", "捡", "打", "播", "击", "捏", "撒", "按",
            "弹", "撞", "提", "扭", "捶", "持", "揍", "披", "捣", "搜", "托", "举", "拖", "擦", "敲", "挖", "抛", "掘", "抬", "插", "扔",
            "写", "抄", "抓", "捧", "掷", "撑", "摊", "倒", "摔", "劈", "画", "搔", "撬", "挥", "揽", "挡", "捺", "抚", "搡", "拉", "摸",
            "拍", "摇", "剪", "拎", "拔", "拧", "拨", "舞", "握", "攥", "退", "进", "奔", "跑", "赶", "趋", "遁", "逃", "立", "站", "跨",
            "踢", "跳", "走", "蹬", "窜", "屈", "转", "蜷", "卧", "仰", "躺", "睡", "趴", "蹲", "弯", "弓", "挺", "俯", "说", "笑", "飞",
            "唱", "坐", "闻", "想", "爱", "恨", "念", "喜欢", "希望", "担", "讨", "觉", "思"
        };
    }
}